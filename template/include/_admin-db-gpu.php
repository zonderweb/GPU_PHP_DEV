...
<div class="admin-article-wrapper">
  ...
  for ($i = 0; $i < count($resultGpu); $i++) {
    ...
    $out .= '<a class="article-edit" title="Редагувати матеріал" href="/admin/update/' . $resultGpu[$i]['id'] . '" onclick="return confirm(\'Точно оновити?\')">Редагувати <span class="material-symbols-outlined">edit_square</span></a>';
