...
<body>
    <div class="admin-area">
        ...
        <header class="admin-header">
            ...
            <div class="header-bottom <?php if ($route[1] == 'gpu-create') echo 'bgc-grey' ?>" <?php if (@$title == NULL) echo 'style="display:none"' ?>>
                <div class="header-container">
                    <div class="header-info">
                        ...
                        if (@$route[1] == 'cat-list-gpu') {
                            echo '<div class="btn-create"><a href="/admin/create-gpu-cat"><span class="material-symbols-outlined">add</span>Створити</a></div>';
                        }
                        ?>
                    </div>
                </div>
