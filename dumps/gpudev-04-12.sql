...
--
-- Хост: localhost
-- Время создания: Дек 04 2023 г., 19:22
...
(11, 'Nvidia', 'nvidia-geforce-gtx-titan-x', 'NVIDIA GeForce GTX TITAN X', 'GM200', 3072, 192, 96, 12, 'GDDR5', 384, 250, 600, '<p>\r\n<b>GeForce GTX TITAN X</b> була відеокартою класу ентузіастів від NVIDIA, представленим 17 березня 2015 року. Побудована на техпроцесі 28 нм та на основі графічного процесора GM200 у варіанті GM200-400-A1, карта підтримує DirectX 12. Це гарантує, що всі сучасні ігри запускатимуться на GeForce GTX TITAN X. Графічний процесор <b>GM200</b> є великим чипом з площею кристала 601 мм² та 8 000 мільйонами транзисторів. Він має 3072 потокових процесорів, 192 одиниці картографування текстур і 96 блоків виведення графіки (ROP). NVIDIA об`єднала з GeForce GTX TITAN X 12 ГБ пам`яті GDDR5, які з`єднані за допомогою 384-бітного інтерфейсу пам`яті. Графічний процесор працює на частоті 1000 МГц, яку можна підняти до 1089 МГц, а частота пам`яті становить 1753 МГц (ефективний тахометр 7 Гбіт/с).\r\n</p>\r\n<p>\r\nБудучи двослотовою відеокартою, NVIDIA GeForce GTX TITAN X отримує живлення від 1x 6-контактного + 1x 8-контактного роз`ємів живлення, з максимальним споживанням енергії 250 Вт. Виводи включають: 1x DVI, 1x HDMI 2.0, 3x DisplayPort 1.2. GeForce GTX TITAN X з`єднана з рештою системи через інтерфейс PCI-Express 3.0 x16. Розміри картки становлять 267 мм х 111 мм х 38 мм, і вона оснащена двослотовим рішенням для охолодження. Ціна на момент випуску складала 999 доларів США.</p>', 'titan-x.jpg', '17-03-2015');
