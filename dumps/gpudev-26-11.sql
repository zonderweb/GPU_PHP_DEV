...
--
-- Хост: localhost
-- Время создания: Ноя 26 2023 г., 18:15
...
INSERT INTO `gpucategory` (`id`, `found`, `url`, `title`, `graph-processor`, `cores`, `tmus`, `rops`, `memory-size`, `memory-type`, `bus-width`, `description`, `img`, `date`) VALUES
