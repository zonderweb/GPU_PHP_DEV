...
--
-- Хост: localhost
-- Время создания: Окт 23 2023 г., 20:28
...
(6, 3, 'Intel Arc Pro A60', 'arc-proa60', 'The Arc Pro A60 is a professional graphics card by Intel, launched on June 6th, 2023.', '<p>lorem ipsum dolor lorem ipsum dolor lorem ipsum dolor lorem ipsum dolor zlorem ipsum dolor lorem ipsum dolor lorem ipsum dolor lorem ipsum dolor lorem <b>ipsum dolor</b></p>', 'proa60-front.jpg'),
(24, 1, 'Новини від Nvidia', 'news-for-nvidia', 'Дізнайтеся, як новий DLSS 3.5 покращує трасування променів за допомогою ШІ', '<p>Нова технологія реконструкції променів підвищує якість зображення на всіх відеокартах GeForce RTX за рахунок використання алгоритмів ШІ для створення додаткових пікселів.</p>', 'geforce-ada-dlss.jpg');
