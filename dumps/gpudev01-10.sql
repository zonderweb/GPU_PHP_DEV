...
--
-- Хост: localhost
-- Время создания: Сен 30 2023 г., 23:36
...
CREATE TABLE `gpuarticle` (
  ...
  `gpu-clock` int(11) NOT NULL,
  `boost-clock` int(11) NOT NULL,
  `memory-clock` int(11) NOT NULL,
  `other-change` varchar(255) NOT NULL,
  `graph-processor` varchar(255) NOT NULL,
  `cores` int(11) NOT NULL,
  `tmus` int(11) NOT NULL,
  `rops` int(11) NOT NULL,
  `memeory-size` int(11) NOT NULL,
...
INSERT INTO `gpuarticle` (`id`, `cid`, `vendor`, `url`, `title`, `description`, `gpu-clock`, `boost-clock`, `memory-clock`, `other-change`, `graph-processor`, `cores`, `tmus`, `rops`, `memeory-size`, `memory-type`, `bus-width`, `img`, `part-num`) VALUES
...
(1, 'admin', '6f37db8b89aaaccbf74767e563faee5f', '3222f039a77d1c016d2d9958885053f9', 2130706433),
